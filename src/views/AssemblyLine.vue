        ...
        >
          ...
          <ul v-if="expanded[index]" class="process-list">
            <li v-for="(process, i) in line.process" :key="i" class="process-item">
              <div class="process-name"><strong>{{ process.name }}</strong></div>
        ...
        <div class="modal-body">
          <div class="scroll-container">
            ...
            <div class="process-list">
              <div v-for="(process, index) in currentLine.process" :key="index" class="process-item">
...
const saveLine = () => {
  ...
  localStorage.setItem('lines', JSON.stringify(assemblyLines.value));
};
</script>
